...
#include "common.h"
#include "activity_recognition_server/robot_tts.h"
#include "activity_recognition_server/user_voice.h"
...
public:
  ...
  bool voiceCallBack(activity_recognition_server::user_voice::Request &req,
