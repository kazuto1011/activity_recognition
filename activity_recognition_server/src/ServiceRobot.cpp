    ...
    nh_(nh), user_activity_(-1)
{
  ...
  tts_client_ = nh_->serviceClient<activity_recognition_server::robot_tts>("smartpal5_tts");
...
//----------------------------------------------------------------------------------
bool ServiceRobot::voiceCallBack(activity_recognition_server::user_voice::Request &req,
                                 activity_recognition_server::user_voice::Response &res)
{
  int tts_mode = 0;
...
{
  activity_recognition_server::robot_tts srv;
